...
use Huynp\HFilemanager\Events\ImageIsRenaming;
use Huynp\HFilemanager\Events\ImageWasRenamed;
use Huynp\HFilemanager\Events\FolderIsRenaming;
use Huynp\HFilemanager\Events\FolderWasRenamed;
...
class RenameController extends LfmController
{
    public function getRename()
    {
        ...
        if (config('hfm.alphanumeric_directory') && preg_match('/[^\w-]/i', $new_name)) {
